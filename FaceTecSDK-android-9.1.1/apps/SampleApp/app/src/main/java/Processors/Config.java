...
public class Config {
    ...
    public static String DeviceKeyIdentifier = "dpcDFOCNR1PFBWRuBrh65Yt4yWWgenIN";
    ...
    public static FaceTecCustomization retrieveConfigurationWizardCustomization() {
        ...
        int frameColor = Color.parseColor("#25bfbe");
        int borderColor = Color.parseColor("#25abbe");
        int ovalColor = Color.parseColor("#0f298c");
        int dualSpinnerColor = Color.parseColor("#25bfbe");
        int textColor = Color.parseColor("#ffffff");
        int buttonAndFeedbackBarColor =  Color.parseColor("#0f298c");
        int buttonAndFeedbackBarTextColor = Color.parseColor("#ffffff");
        int buttonColorPressed = Color.parseColor("#6293ef");
        ...
        FaceTecCancelButtonCustomization.ButtonLocation cancelButtonLocation = FaceTecCancelButtonCustomization.ButtonLocation.TOP_RIGHT;
