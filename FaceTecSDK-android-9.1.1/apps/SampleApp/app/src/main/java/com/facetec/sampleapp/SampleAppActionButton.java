...
public class SampleAppActionButton extends AppCompatButton {
    ...
    public void setupButton(final SampleAppActivity activity) {
        ...
        mBackgroundDrawable = getResources().getDrawable(R.drawable.sample_button_bg).mutate(); // ContextCompat.getDrawable(context, R.drawable.sample_button_bg);
        if(mBackgroundDrawable != null && mBackgroundDrawable instanceof  GradientDrawable) {
            ...
            ((GradientDrawable)mBackgroundDrawable).setCornerRadius((float)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mCornerRadius, Resources.getSystem().getDisplayMetrics()));
        }
