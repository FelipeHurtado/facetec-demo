...
public class SampleAppUtilities {
    ...
    public String currentTheme = "FaceTec Theme";
        ...
        sampleAppActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                switch(vocalGuidanceMode) {
                    case OFF:
                        vocalGuidanceMode = SampleAppUtilities.VocalGuidanceMode.MINIMAL;
                        sampleAppActivity.activityMainBinding.vocalGuidanceSettingButton.setBackgroundResource(R.drawable.vocal_minimal);
                    ...
                    case MINIMAL:
                        ...
                        sampleAppActivity.activityMainBinding.vocalGuidanceSettingButton.setBackgroundResource(R.drawable.vocal_full);
                        vocalGuidanceOnPlayer.start();
                    ...
                    case FULL:
                        ...
                        sampleAppActivity.activityMainBinding.vocalGuidanceSettingButton.setBackgroundResource(R.drawable.vocal_off);
